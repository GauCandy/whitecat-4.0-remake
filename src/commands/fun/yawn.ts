...
const command: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        try {
            ...
            const gifUrl = await getNekobest(NekobestExpression.Yawn);

            // Get random message from array
            const messages = t(locale, 'commands.fun.yawn.message');
            ...
            logger.error('Error in yawn command:', error);
