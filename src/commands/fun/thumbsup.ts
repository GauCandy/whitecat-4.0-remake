...
const command: Command = {
    data: new SlashCommandBuilder()
        .setName('thumbsup')
        .setDescription(t(Locale.English, 'commands.fun.thumbsup.description'))
        .setDescriptionLocalizations({
            vi: t(Locale.Vietnamese, 'commands.fun.thumbsup.description'),
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        try {
            ...
            const messages = t(locale, 'commands.fun.thumbsup.message');
