...
const punchCommand: SlashCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
      const gifUrl = await nekosService.getRandomGif('punch');
      const message = await localeService.tGuild(
        interaction.guildId,
        'commands.fun.punch.message',
        {
          user: interaction.user.toString(),
